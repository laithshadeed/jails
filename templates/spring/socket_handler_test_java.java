 ...
 * container instead.
 */
class {{name}}SocketHandlerTest {

    @Test
    void aMessageReachesEveryConnectedSession() throws Exception {
        {{name}}SocketHandler handler = new {{name}}SocketHandler();
    ...
    private static WebSocketSession connected({{name}}SocketHandler handler, String id) {
