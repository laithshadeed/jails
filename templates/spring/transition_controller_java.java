...
{{path_variable_import}}{{binding_import}}import org.springframework.web.bind.annotation.RequestHeader;
...
{{scope_checks}}
        ...
        // chose.
        return switch (useCase.execute({{key_expression}}, command, expected)) {
{{arms}}
        };
    }
