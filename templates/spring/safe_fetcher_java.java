 ...
 */
@Component
public final class Safe{{name}}Fetcher implements {{name}}Fetcher {
    ...
    @Autowired
    public Safe{{name}}Fetcher(
            @Value("${jails.fetchers.{{property}}.connect-timeout:2s}") Duration connectTimeout,
            @Value("${jails.fetchers.{{property}}.response-timeout:10s}") Duration responseTimeout,
