...
- **Bytecode Dependency Extraction**: Reads constant pools from compiled `.class` files in `target/classes` to discover transitive type dependencies for [`jails testd --affected`](file:///home/laith/code/jails/crates/jails-drive/src/testd.rs).
...
- [`classfile`](file:///home/laith/code/jails/crates/jails-java/src/classfile.rs):
...
- [`java`](file:///home/laith/code/jails/crates/jails-java/src/java.rs):
...
- [`annotate`](file:///home/laith/code/jails/crates/jails-java/src/annotate.rs):
  - Splices annotations like `@Import(...)` onto `@SpringBootTest` test classes when installing capabilities like `db` or `kafka`.
- [`template`](file:///home/laith/code/jails/crates/jails-java/src/template.rs):
...
- **Used by [`jails-generate`](file:///home/laith/code/jails/crates/jails-generate/README.md)**: Generates Java classes, formats imports, and applies templates.
- **Used by [`jails-drive`](file:///home/laith/code/jails/crates/jails-drive/README.md)**: Uses `classfile` to power [`testd --affected`](file:///home/laith/code/jails/crates/jails-drive/src/testd.rs) dependency graphs.
- **Used by [`jails-report`](file:///home/laith/code/jails/crates/jails-report/README.md)**: Inspects Spring annotations (`@Component`, `@Repository`, `@GetMapping`) for route and bean listings.
