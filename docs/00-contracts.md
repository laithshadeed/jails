...
| `docs/71-interface-deep.md` | the second walk: where a mutation spends its time, the wider surfaces, and the ideas that would change what the tool is to a reader | the same readers, after `70` |
