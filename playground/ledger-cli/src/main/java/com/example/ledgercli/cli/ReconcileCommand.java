 ...
 * class, so {@code reconcile} already works. If you need to do it by hand -- a
...
public final class ReconcileCommand {
    ...
    public static final String USAGE = "usage: reconcile <argument>";
