...
@Component
public final class JdbcMembersByWorkspaceQuery implements MembersByWorkspaceQueryPort {
    ...
    public JdbcMembersByWorkspaceQuery(JdbcClient db) {
        this.db = Objects.requireNonNull(db, "db is required");
    }

    @Override
    public List<Member> execute(MembersByWorkspaceQuery query) {
        ...
        return db.sql("""
                ...
                .query(JdbcMembersByWorkspaceQuery::map)
                .list();
    }
