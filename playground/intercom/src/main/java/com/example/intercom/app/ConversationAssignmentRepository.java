...
/**
 * Storage for {@link ConversationAssignment}, as the application sees it.
 *
 ...
 */
public interface ConversationAssignmentRepository {

    Optional<ConversationAssignment> findById(String id);

    List<ConversationAssignment> findAll();

    /** Inserts a row. Define conflict behavior explicitly in the SQL adapter. */
    void save(ConversationAssignment conversationAssignment);
