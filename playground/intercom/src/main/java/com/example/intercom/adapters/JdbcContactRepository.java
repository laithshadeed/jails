...
/**
 * {@link ContactRepository} over {@link JdbcClient}. No ORM: the queries are
...
public final class JdbcContactRepository implements ContactRepository {
    ...
    public JdbcContactRepository(JdbcClient db) {
    ...
    public Optional<Contact> findById(String id) {
        ...
        return db.sql("""
                        ...
                        """.formatted(COLUMNS))
                .param("id", id)
                .query(JdbcContactRepository::map)
                .optional();
    }
    ...
    public void save(Contact contact) {
        ...
        db.sql("""
                        insert into contacts (id, workspace_id, email, display_name, created_at, updated_at)
                        values (:id, :workspace_id, :email, :display_name, :created_at, :updated_at)
                        """)
                .param("id", contact.id())
                .param("workspace_id", contact.workspaceId())
                .param("email", contact.email())
                .param("display_name", contact.displayName().orElse(null))
                .param("created_at", Timestamp.from(contact.createdAt()))
                .param("updated_at", Timestamp.from(contact.updatedAt()))
                .update();
    }
    ...
    /** Builds a Contact from the current row. */
