...
class ReassignConversationControllerTest {

    private final MockMvcTester mvc = MockMvcTester.of(new ReassignConversationController(
    ...
    void putExecutesTheTransition() {
        assertThat(mvc.put().uri(ReassignConversationController.PATH)
