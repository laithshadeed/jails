...
class ContactsByWorkspaceQueryControllerTest {

    private final MockMvcTester mvc = MockMvcTester.of(new ContactsByWorkspaceQueryController(
            query -> List.of(new Contact(
    ...
    void postExecutesTheDatabaseQueryPort() {
        assertThat(mvc.post()
                .uri(ContactsByWorkspaceQueryController.PATH)
