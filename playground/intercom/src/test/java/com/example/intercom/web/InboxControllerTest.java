...
class InboxControllerTest {
    ...
    /**
     * The body {@code requests/inbox.http} documents, generated from
     * the same builder.
     *
    ...
    void setUp() {
        ...
        mvc = MockMvcTester.of(new InboxController(service, scopeAuthorizer));
    }
    ...
    void broadUnscopedReadsAreNotExposed() {
        assertThat(mvc.get().uri(InboxController.PATH)).hasStatus(405);
        assertThat(mvc.get().uri(InboxController.PATH + "/other-tenant-id")).hasStatus(404);
    }
}
