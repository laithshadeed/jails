...
class JdbcInboxMembersByInboxQueryIT {

    @Autowired
    private InboxMemberRepository repository;

    @Autowired
    private InboxMembersByInboxQueryPort queryPort;

    @Test
    void filtersInTheRealDatabase() {
        InboxMember stored = new InboxMember(
        ...
        var found = queryPort.execute(new InboxMembersByInboxQuery(
                UUID.fromString("00000000-0000-0000-0000-000000000001"),
                UUID.fromString("00000000-0000-0000-0000-000000000001")));
