...
class InboxesByWorkspaceQueryControllerTest {

    private final MockMvcTester mvc = MockMvcTester.of(new InboxesByWorkspaceQueryController(
            query -> List.of(new Inbox(
    ...
    void postExecutesTheDatabaseQueryPort() {
        assertThat(mvc.post()
                .uri(InboxesByWorkspaceQueryController.PATH)
