...
@SpringBootTest
@Transactional
class AssignmentMemberAssociationIT {
    ...
    void schemaCarriesTheExactOrderedCompositeRelationship() {
        String mapping = db.sql("""
                        ...
                        """)
                .param("constraint", "conversation_assignments_assignment_member_fk")
                .query(String.class)
                .single();
    ...
    void existingCrossBoundaryDataCannotPassConstraintValidation() {
        db.sql("alter table conversation_assignments drop constraint conversation_assignments_assignment_member_fk").update();
        db.sql("""
        ...
        assertThatThrownBy(() -> db.sql(
                        "alter table conversation_assignments validate constraint conversation_assignments_assignment_member_fk")
                .update())
                .isInstanceOf(DataAccessException.class)
                .rootCause()
                .hasMessageContaining("conversation_assignments_assignment_member_fk");
    }
}
