...
class ChangeConversationStatusControllerTest {

    private final MockMvcTester mvc = MockMvcTester.of(new ChangeConversationStatusController(
    ...
    void putExecutesTheTransition() {
        assertThat(mvc.put().uri(ChangeConversationStatusController.PATH)
