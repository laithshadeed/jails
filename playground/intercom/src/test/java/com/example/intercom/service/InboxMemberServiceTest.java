...
class InboxMemberServiceTest {

    private final InboxMemberRepository repository = mock(InboxMemberRepository.class);
    private final InboxMemberService service = new InboxMemberService(repository);
