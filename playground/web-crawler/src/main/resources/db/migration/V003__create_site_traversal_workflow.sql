create table site_traversal_runs (
id uuid primary key,
...
create table site_traversal_frontier (
run_id uuid not null references site_traversal_runs(id) on delete cascade,
url text not null,
...
create index site_traversal_frontier_runnable_idx
on site_traversal_frontier (state, next_attempt_at)
where state in ('PENDING','RUNNING');

create table site_traversal_pages (
run_id uuid not null references site_traversal_runs(id) on delete cascade,
url text not null,
