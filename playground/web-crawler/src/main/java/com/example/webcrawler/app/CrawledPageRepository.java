package com.example.webcrawler.app;
...
/**
 * Storage for {@link CrawledPage}, as the application sees it.
 *
...
public interface CrawledPageRepository {
    ...
    Optional<CrawledPage> findById(String id);

    List<CrawledPage> findAll();

    /** Inserts a row. Define conflict behavior explicitly in the SQL adapter. */
    void save(CrawledPage crawledPage);
