...
/**
 * Consumes {@link PaymentAuthorisedEvent}.
 *
 ...
 */
@Component
public class PaymentAuthorisedListener {

    private static final Logger log = LoggerFactory.getLogger(PaymentAuthorisedListener.class);

    @KafkaListener(topics = "${topics.payment-authorised:payment-authorised}")
    public void on(PaymentAuthorisedEvent event) {
