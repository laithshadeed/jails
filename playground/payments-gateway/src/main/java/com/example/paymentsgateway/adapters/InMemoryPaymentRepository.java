...
/**
 * {@link PaymentRepository} in memory, so the application runs before it has
 * a database.
 *
 ...
 * reproduce.
 *
 * <p>Not a bean: this project has a {@code DataSource}, so {@code JdbcPaymentRepository}
...
public class InMemoryPaymentRepository implements PaymentRepository {
    ...
    private final Map<String, Payment> items = new ConcurrentHashMap<>();
    ...
    public void save(Payment payment) {
        items.put(String.valueOf(payment.id()), payment);
    }
