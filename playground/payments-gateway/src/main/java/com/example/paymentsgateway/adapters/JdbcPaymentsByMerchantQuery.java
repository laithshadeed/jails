...
@Component
public final class JdbcPaymentsByMerchantQuery implements PaymentsByMerchantQueryPort {
    ...
    public JdbcPaymentsByMerchantQuery(JdbcClient db) {
        this.db = Objects.requireNonNull(db, "db is required");
    }

    @Override
    public List<Payment> execute(PaymentsByMerchantQuery query) {
        ...
        return db.sql("""
                ...
                .query(JdbcPaymentsByMerchantQuery::map)
                .list();
    }
