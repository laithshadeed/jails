...
class AcquirerSettlementHttpOutboxSinkTest {
    ...
    void repeatedAttemptsCarryTheSameIdempotencyKeyAndTypedJson() throws IOException {
        ...
        assertThatThrownBy(() -> sink("/reject").deliver(event))
                .isInstanceOf(AcquirerSettlementHttpOutboxSink.DeliveryException.class)
                .hasMessageContaining("503");
    }

    private AcquirerSettlementHttpOutboxSink sink(String path) {
        return new AcquirerSettlementHttpOutboxSink(
