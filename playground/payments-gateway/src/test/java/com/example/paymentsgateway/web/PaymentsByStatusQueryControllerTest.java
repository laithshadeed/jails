...
class PaymentsByStatusQueryControllerTest {

    private final MockMvcTester mvc = MockMvcTester.of(new PaymentsByStatusQueryController(
    ...
    void postExecutesTheDatabaseQueryPort() {
        assertThat(mvc.post()
                .uri(PaymentsByStatusQueryController.PATH)
