// Generated by jails from art_ent_payout_repository_contract. Clean hand edits survive regeneration.
...
/**
 * What every PayoutRepository must do, whichever one it is.
 *
 ...
 */
public final class PayoutRepositoryContract {

    private PayoutRepositoryContract() {}

    public static void savesReadsAndDeletes(PayoutRepository repository, Payout sample) {
        ...
        Payout stored = repository.save(sample);
