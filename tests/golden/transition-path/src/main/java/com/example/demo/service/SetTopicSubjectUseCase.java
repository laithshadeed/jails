 ...
 */
@FunctionalInterface
public interface SetTopicSubjectUseCase {

    /**
     * @param userId which row to change. A separate argument rather
    ...
    sealed interface Result {
        ...
        record Applied(Topic resource) implements Result {}
         ...
         * second request.
         */
        record StaleVersion(Topic current) implements Result {}
