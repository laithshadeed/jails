// Generated by jails from art_ent_topic_dto_test. Clean hand edits survive regeneration.
...
final class TopicDtoTest {

    @Test
    void theResponseProjectsEveryComponent() {
        assertEquals(List.of("id", "userId", "subject", "version"), componentNames(TopicResponse.class));
    }
    ...
    void theRequestAsksOnlyForCallerSuppliedComponents() {
        assertEquals(List.of("userId", "subject"), componentNames(TopicRequest.class));
    }
