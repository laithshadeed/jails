...
class TopicControllerTest {
    ...
    /**
     * The body {@code requests/topic.http} documents, generated from
     * the same builder.
     *
    ...
    void setUp() {
        ...
        mvc = MockMvcTester.of(new TopicController(service));
    }
    ...
    void anEmptyCollectionIsAnEmptyArray() {
        ...
        assertThat(mvc.get().uri(TopicController.PATH))
                .hasStatusOk()
                .bodyJson()
                .isEqualTo("[]");
    }
    ...
    void aMissingItemIs404() {
        ...
        assertThat(mvc.get().uri(TopicController.PATH + "/" + missing)).hasStatus(404);
    }
    ...
    void aDeleteThatRemovedNothingIs404() {
        ...
        assertThat(mvc.delete().uri(TopicController.PATH + "/" + missing)).hasStatus(404);
    }
}
