// Generated by jails from art_ent_topic_repository_contract. Clean hand edits survive regeneration.
...
/**
 * What every TopicRepository must do, whichever one it is.
 *
 ...
 */
public final class TopicRepositoryContract {

    private TopicRepositoryContract() {}

    public static void savesReadsAndDeletes(TopicRepository repository, Topic sample) {
        ...
        Topic stored = repository.save(sample);
