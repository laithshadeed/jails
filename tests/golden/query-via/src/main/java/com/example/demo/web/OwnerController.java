// Generated by jails from art_ent_owner_http_controller. Clean hand edits survive regeneration.
...
public final class OwnerController {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<Owner> byId(@PathVariable("id") UUID id) {
     ...
     * {@link OwnerRequest#toDomain()} rather than taken from the body.
     */
    @PostMapping
    public ResponseEntity<Owner> create(@Valid @RequestBody OwnerRequest request) {
        Owner created = service.save(request.toDomain());
