// Generated by jails from art_ent_item_repository_contract. Clean hand edits survive regeneration.
...
/**
 * What every ItemRepository must do, whichever one it is.
 *
 ...
 */
public final class ItemRepositoryContract {

    private ItemRepositoryContract() {}

    public static void savesReadsAndDeletes(ItemRepository repository, Item sample) {
        ...
        Item stored = repository.save(sample);
