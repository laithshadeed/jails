// Generated by jails from art_ent_operator_repository_contract. Clean hand edits survive regeneration.
...
/**
 * What every OperatorRepository must do, whichever one it is.
 *
 ...
 */
public final class OperatorRepositoryContract {

    private OperatorRepositoryContract() {}

    public static void savesReadsAndDeletes(OperatorRepository repository, Operator sample) {
        ...
        Operator stored = repository.save(sample);
