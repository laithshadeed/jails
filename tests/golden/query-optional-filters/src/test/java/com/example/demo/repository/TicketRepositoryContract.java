// Generated by jails from art_ent_ticket_repository_contract. Clean hand edits survive regeneration.
...
/**
 * What every TicketRepository must do, whichever one it is.
 *
 ...
 */
public final class TicketRepositoryContract {

    private TicketRepositoryContract() {}

    public static void savesReadsAndDeletes(TicketRepository repository, Ticket sample) {
        ...
        Ticket stored = repository.save(sample);
