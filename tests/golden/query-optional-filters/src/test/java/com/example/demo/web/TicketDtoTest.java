// Generated by jails from art_ent_ticket_dto_test. Clean hand edits survive regeneration.
...
final class TicketDtoTest {

    @Test
    void theResponseProjectsEveryComponent() {
        assertEquals(List.of("id", "status", "category"), componentNames(TicketResponse.class));
    }
    ...
    void theRequestAsksOnlyForCallerSuppliedComponents() {
        assertEquals(List.of("status", "category"), componentNames(TicketRequest.class));
    }
