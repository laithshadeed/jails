...
class TicketControllerTest {
    ...
    /**
     * The body {@code requests/ticket.http} documents, generated from
     * the same builder.
     *
    ...
    void setUp() {
        ...
        mvc = MockMvcTester.of(new TicketController(service));
    }
    ...
    void anEmptyCollectionIsAnEmptyArray() {
        ...
        assertThat(mvc.get().uri(TicketController.PATH))
                .hasStatusOk()
                .bodyJson()
                .isEqualTo("[]");
    }
    ...
    void aMissingItemIs404() {
        ...
        assertThat(mvc.get().uri(TicketController.PATH + "/" + missing)).hasStatus(404);
    }
    ...
    void aDeleteThatRemovedNothingIs404() {
        ...
        assertThat(mvc.delete().uri(TicketController.PATH + "/" + missing)).hasStatus(404);
    }
}
