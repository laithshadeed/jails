...
final class NoteDtoTest {
    ...
    void theResponseProjectsEveryComponent() {
        assertEquals(List.of("id", "authorId", "body", "senderType"), componentNames(NoteResponse.class));
    }
    ...
    void theRequestAsksOnlyForCallerSuppliedComponents() {
        assertEquals(List.of("authorId", "body", "senderType"), componentNames(NoteRequest.class));
    }
