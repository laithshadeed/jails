...
class AuthorControllerTest {
    ...
    /**
     * The body {@code requests/author.http} documents, generated from
     * the same builder.
     *
    ...
    void setUp() {
        ...
        mvc = MockMvcTester.of(new AuthorController(service));
    }
    ...
    void anEmptyCollectionIsAnEmptyArray() {
        ...
        assertThat(mvc.get().uri(AuthorController.PATH))
                .hasStatusOk()
                .bodyJson()
                .isEqualTo("[]");
    }
    ...
    void aMissingItemIs404() {
        ...
        assertThat(mvc.get().uri(AuthorController.PATH + "/" + missing)).hasStatus(404);
    }
    ...
    void aDeleteThatRemovedNothingIs404() {
        ...
        assertThat(mvc.delete().uri(AuthorController.PATH + "/" + missing)).hasStatus(404);
    }
}
