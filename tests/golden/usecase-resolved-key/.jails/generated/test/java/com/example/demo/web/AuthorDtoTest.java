// Generated by jails from art_ent_author_dto_test. Clean hand edits survive regeneration.
...
final class AuthorDtoTest {

    @Test
    void theResponseProjectsEveryComponent() {
        assertEquals(List.of("id", "email"), componentNames(AuthorResponse.class));
    }
    ...
    void theRequestAsksOnlyForCallerSuppliedComponents() {
        assertEquals(List.of("email"), componentNames(AuthorRequest.class));
    }
