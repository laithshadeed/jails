// Generated by jails from art_ent_note_repository_contract. Clean hand edits survive regeneration.
...
/**
 * What every NoteRepository must do, whichever one it is.
 *
 ...
 */
public final class NoteRepositoryContract {

    private NoteRepositoryContract() {}

    public static void savesReadsAndDeletes(NoteRepository repository, Note sample) {
        ...
        Note stored = repository.save(sample);
