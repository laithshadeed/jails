// Generated by jails from art_ent_owner_repository_contract. Clean hand edits survive regeneration.
...
/**
 * What every OwnerRepository must do, whichever one it is.
 *
 ...
 */
public final class OwnerRepositoryContract {

    private OwnerRepositoryContract() {}

    public static void savesReadsAndDeletes(OwnerRepository repository, Owner sample) {
        ...
        Owner stored = repository.save(sample);
