// Generated by jails from art_ent_message_dto_test. Clean hand edits survive regeneration.
...
final class MessageDtoTest {

    @Test
    void theResponseProjectsEveryComponent() {
        assertEquals(List.of("id", "body", "createdAt"), componentNames(MessageResponse.class));
    }
    ...
    void theRequestAsksOnlyForCallerSuppliedComponents() {
        assertEquals(List.of("body"), componentNames(MessageRequest.class));
    }
