// Generated by jails from art_ent_message_repository_contract. Clean hand edits survive regeneration.
...
/**
 * What every MessageRepository must do, whichever one it is.
 *
 ...
 */
public final class MessageRepositoryContract {

    private MessageRepositoryContract() {}

    public static void savesReadsAndDeletes(MessageRepository repository, Message sample) {
        ...
        Message stored = repository.save(sample);
