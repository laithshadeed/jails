// Generated by jails from art_ent_article_repository_contract. Clean hand edits survive regeneration.
...
/**
 * What every ArticleRepository must do, whichever one it is.
 *
 ...
 */
public final class ArticleRepositoryContract {

    private ArticleRepositoryContract() {}

    public static void savesReadsAndDeletes(ArticleRepository repository, Article sample) {
        ...
        Article stored = repository.save(sample);
