// Generated by jails from art_ent_article_dto_test. Clean hand edits survive regeneration.
...
final class ArticleDtoTest {

    @Test
    void theResponseProjectsEveryComponent() {
        assertEquals(List.of("id", "title", "body"), componentNames(ArticleResponse.class));
    }
    ...
    void theRequestAsksOnlyForCallerSuppliedComponents() {
        assertEquals(List.of("title", "body"), componentNames(ArticleRequest.class));
    }
