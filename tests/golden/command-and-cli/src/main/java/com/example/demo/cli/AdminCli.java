...
/**
 * Argv dispatch for the admin command line: it owns argument routing, exit
 ...
 * int code = AdminCli.run(AdminCli.commands(), new PrintStream(out), System.err, "greet", "world");
 * }
 */
public final class AdminCli {
    ...
    private static void usage(SequencedMap<String, Command> commands, PrintStream to) {
        to.println("usage: admin <command> [args]");
        to.println();
        to.println("commands:");
        to.println("  help");
