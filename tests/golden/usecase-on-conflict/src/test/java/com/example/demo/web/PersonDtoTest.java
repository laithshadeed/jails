// Generated by jails from art_ent_person_dto_test. Clean hand edits survive regeneration.
...
final class PersonDtoTest {

    @Test
    void theResponseProjectsEveryComponent() {
        assertEquals(List.of("id", "email", "createdAt"), componentNames(PersonResponse.class));
    }
    ...
    void theRequestAsksOnlyForCallerSuppliedComponents() {
        assertEquals(List.of("email"), componentNames(PersonRequest.class));
    }
