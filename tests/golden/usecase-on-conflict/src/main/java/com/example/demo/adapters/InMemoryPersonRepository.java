...
/**
 * {@link PersonRepository} in memory, so the application runs before it has
 * a database.
 *
 ...
 * reproduce.
 *
 * <p>Not a bean: this project has a {@code DataSource}, so {@code JdbcPersonRepository}
...
public class InMemoryPersonRepository implements PersonRepository {
    ...
    private final Map<UUID, Person> items = new ConcurrentHashMap<>();
