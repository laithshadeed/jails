// Generated by jails from art_ent_widget_dto_test. Clean hand edits survive regeneration.
...
final class WidgetDtoTest {

    @Test
    void theResponseProjectsEveryComponent() {
        assertEquals(List.of("id", "name"), componentNames(WidgetResponse.class));
    }
    ...
    void theRequestAsksOnlyForCallerSuppliedComponents() {
        assertEquals(List.of("name"), componentNames(WidgetRequest.class));
    }
