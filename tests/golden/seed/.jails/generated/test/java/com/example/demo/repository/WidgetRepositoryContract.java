// Generated by jails from art_ent_widget_repository_contract. Clean hand edits survive regeneration.
...
/**
 * What every WidgetRepository must do, whichever one it is.
 *
 ...
 */
public final class WidgetRepositoryContract {

    private WidgetRepositoryContract() {}

    public static void savesReadsAndDeletes(WidgetRepository repository, Widget sample) {
        ...
        Widget stored = repository.save(sample);
